...
typedef struct { int power1, power2, power3, Vrms, battery; } PayloadTX;         // neat way of packaging data for RF comms
PayloadTX emontx;
...
void setup() 
{
  ...
  ct1.voltageTX(114, 1.7);                                         // ct.voltageTX(calibration, phase_shift) - make sure to select correct calibration for AC-AC adapter  http://openenergymonitor.org/emon/modules/emontx/firmware/calibration
  ...
  ct2.voltageTX(114, 1.7);                                         // CT Calibration factor = (100A / 0.05A) x 18 Ohms
  ct2.currentTX(2, 111.1);
  
  ct3.voltageTX(114, 1.7);
